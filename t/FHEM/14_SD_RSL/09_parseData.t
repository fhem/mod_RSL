...
use Test2::FHEM::SIGNALduino::RDmsg;
...
sub runTest {
	...
	push @Test2::FHEM::SIGNALduino::RDmsgJSONTestList, {
		testname	=> qq[Testdata with $module data],
		url			=> qq[$filepath/testData.json],
	};

	plan( scalar @Test2::FHEM::SIGNALduino::RDmsgJSONTestList);
	for my $maintest  (@Test2::FHEM::SIGNALduino::RDmsgJSONTestList)
	{
		subtest $maintest->{testname} => sub {
			Test2::FHEM::SIGNALduino::RDmsg::dmsgCheck($maintest,$module,$ioHash);
		};
	}
	exit(0);
}
